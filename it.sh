...
echo "[$2]DOS WIFI EVILLIMITER"
echo "[$3]PHISING FACEBOOK LOGIN"
echo "[$4]PHISING FREEFIRE"
echo "[$5]PHISING MOBILE LEGENDS"
echo "[$6]INSTALL METASPLOIT"
echo "[$7]CEK HASIL PHISHING"
echo "[$8]DDOS ATTACK"
echo "[$9]MENCARI KELEMAHAN WEBSITE"
echo "[$0]MEMBUKA INFORMASI FACEBOOK"
echo "___________________________________________________________________________"
echo "╭─[D4RK-IT@Root]"
read -p"╰─>> " pil
...
echo "---------------------------------------------------------------------------"
echo "[+]SEMUA BAHAN AKAN DI INSTALL MOHON TUNGGU BEBERAPA MENIT"
echo "---------------------------------------------------------------------------"
sleep 5
apt update
apt upgrade
...
apt install fish
echo "============================="
echo "SEMUA BAHAN SUDAH DI INSTALL"
echo "============================="
sleep 3
./it.sh
fi
