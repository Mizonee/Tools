...
echo "########################################################################################################"
toilet -f future "Welcome To Tools MrXonee"
...
toilet -f furure "WE ARE ANONYMOUS" | lolcat
echo "********************************************************************************************************"
toilet -f future "[!]it is recommended to use a wifi adapter[!]" | lolcat
echo "********************************************************************************************************"
echo "$1[1]─>>INSTALL ALL PACKAGE FOR RUNNING TOOLS"
echo "$2[2]─>>TOOLS CONTROL NETWORK EVILLIMITER"
echo "$3[3]─>>TOOLS CRACK WIFI FLUXION"
echo "$4[4]─>>TOOLS"
echo "$5[5]─>>TOOLS"
echo "$6[6]─>>TOOLS"
echo "$7[7]─>>TOOLS"
